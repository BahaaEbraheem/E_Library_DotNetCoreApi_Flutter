              ...
              ListTile(
                ...
                subtitle: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'الناشر: ${book.publisherName ?? 'غير معروف'}',
                      style: const TextStyle(fontSize: 12),
                    ),
                  ],
                ),
                        ...
                        if (authState is AuthAuthenticated &&
                          ...
                          IconButton(
                            ...
                            onPressed: () {
                              // طباعة للتشخيص
                              debugPrint(
                                'تم النقر على زر التعديل للكتاب: ${book.id}',
                              );
                              debugPrint(
                                'بيانات الكتاب المراد تعديلها: ${book.toJson()}',
                              );
                              ...
                              Navigator.pushNamed(
                                ...
                                // إعادة تحميل الكتب بعد العودة من صفحة التعديل
                                _loadBooks();
                              });
